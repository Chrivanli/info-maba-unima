...
<main>
    <div class="col py-3 d-none d-sm-block sub-nav-bg">
            <ol class="breadcrumb mb-1 px-3 fs-6 fw-semibold">
                ...
                <li class="breadcrumb-item"><a href="<?= BASEURL; ?>/rekap/maba_rekap" class="link">Total</a></li>
            </ol>
    </div>
    ...
    <div class="container-fluid">
        <div class="col mt-3">
            <div class="card mb-1 animate__animated animate__fadeIn">
              <div class="card-header text-light ">
                    <div class="row">
                        <div class="col-2"></div>
                        <div class="col">
                            <h5 class="card-title text-center mb-0">REKAP TOTAL PENERIMAAN MAHASISWA BARU</h5>
                        </div>
                    ...
                    <div class="card animate__animated animate__fadeInRight">
                        <div class="card-body pt-0" style="height: 265px;">
                            <a class="pe-3 mt-1 btn z-0 position-absolute top-0 end-0" id="downloadBarPmb" 
                                download="BarChart Maba Rekap Total.png" href="">
            ...
            <div class="card mb-3 animate__animated animate__fadeIn">
                ...
                <div class="card-body">
                    <?php require_once 'table/data-total-s1-rekap.php' ?>
                </div>
            </div>
            <div class="card mb-2 animate__animated animate__fadeIn">
                ...
                <div class="card-body">
                    <?php require_once 'table/data-total-d3-rekap.php' ?>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form id="myForm" method="POST" action="<?= BASEURL; ?>/rekap/total">
...
<script>
    ...
    new Chart(ctx, {
            ...
            datasets: [{
                ...
                data: [
                    '<?=$jumlahS1+$jumlahD3?>',
                    '<?=$jumlahS1Reg+$jumlahD3Reg?>',
                    '<?=$jumlahS1Nim+$jumlahD3Nim?>'
                    ],
