...
<main>
    <div class="col py-3 d-none d-sm-block sub-nav-bg">
            <ol class="breadcrumb mb-1 px-3 fs-6 fw-semibold">
                ...
                <li class="breadcrumb-item"><a href="<?= BASEURL; ?>/daftar_kembali/jenis_kelamin" class="link">Jenis Kelamin - Tahun <?=$data['y_post']?></a></li>
            </ol>
    </div>
    <div class="container-fluid px-4">
        <div class="col mt-3">
                    ...
                    <div class="card animate__animated animate__fadeInLeft">
                        <div class="card-body pt-0" style="height: 265px;">
                            <a class="pe-3 mt-1 btn z-0 position-absolute top-0 end-0" id="downloadpieChart" 
                                download="PieChart Jenis Kelamin Maba Daftar Kembali Tahun <?=$data['y_post']?>.png" href="">
                    ...
                    <div class="card animate__animated animate__fadeInRight">
                        <div class="card-body pt-0" style="height: 265px;">
                            <a class="pe-3 mt-1 btn z-0 position-absolute top-0 end-0" id="downloadbarChart" 
                                download="BarChart jenis kelamin Maba Daftar Kembali Tahun <?=$data['y_post']?>.png" href="">
                                <i data-feather="download" style="width: 80%;"></i>
                            </a> 
            ...
            <div class="card mb-3 animate__animated animate__fadeIn">
                ...
                <div class="card-body">
                    <?php require 'table/data-jenis-kelamin-s1-daftar-kembali.php' ?>
                </div>
            </div>
            <div class="card mb-2">
                <div class="card-header text-light">
                ...
                <div class="card-body">
                    <?php require 'table/data-jenis-kelamin-d3-daftar-kembali.php' ?>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form id="myForm" method="POST" action="<?= BASEURL; ?>/daftar_kembali/jenis_kelamin">
