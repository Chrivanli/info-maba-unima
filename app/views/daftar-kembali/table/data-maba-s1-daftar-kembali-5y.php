...
$('#MabaS1').DataTable({
    ...
    buttons: [
        {
            extend: 'excel',
            title: 'Rekap Daftar Kembali Berdasarkan Jalur Pendaftaran <?=$data['y_last']?> Tahun Terakhir Jenjang S1',
            filename: 'Rekap Daftar Kembali Berdasarkan Jalur Pendaftaran <?=$data['y_last']?> Tahun Terakhir Jenjang S1',
            footer: true,
            exportOptions: {
