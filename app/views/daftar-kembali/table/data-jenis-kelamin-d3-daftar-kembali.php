...
<script>
    ...
    $('#MabaJKD3').DataTable({
        ...
        buttons: [
            {
                extend: 'excel',
                title: 'Rekap Daftar Kembali Berdasarkan Jenis Kelamin Tahun <?=$data['y_post']?> Jenjang D3',
                filename: 'Rekap Daftar Kembali Berdasarkan Jenis Kelamin Tahun <?=$data['y_post']?> Jenjang D3',
                footer: true
            },
            ],
        columnDefs: [
