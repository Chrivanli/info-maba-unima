...
$('#MabaD3').DataTable({
    ...
    buttons: [
        {
            extend: 'excel',
            title: 'Rekap Daftar Kembali Berdasarkan Jalur Pendaftaran <?=$data['y_last']?> Tahun Terakhir Jenjang D3',
            filename: 'Rekap Daftar Kembali Berdasarkan Jalur Pendaftaran <?=$data['y_last']?> Tahun Terakhir Jenjang D3',
            footer: true,
            exportOptions: {
