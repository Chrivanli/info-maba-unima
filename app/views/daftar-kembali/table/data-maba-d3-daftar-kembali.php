<!-- Rekap Maba Jalur Pendaftaran Curent D3-->
<!-- Daftar Kembali -->
...
<script>
    new DataTable('#MabaD3Reg', {
        ...
        buttons: [
            {
                extend: 'excel',
                title: 'Rekap Daftar Kembali Berdasarkan Jalur Pendaftaran Tahun <?=$data['y_post']?> Jenjang D3',
                filename: 'Rekap Daftar Kembali Berdasarkan Jalur Pendaftaran Tahun <?=$data['y_post']?> Jenjang D3',
                footer: true
            },
            ],
        columnDefs: [
