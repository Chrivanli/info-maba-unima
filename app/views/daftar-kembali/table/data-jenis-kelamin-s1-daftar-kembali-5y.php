...
$('#MabaJKS1').DataTable({
    ...
    buttons: [
        {
            extend: 'excel',
            title: 'Rekap Daftar Kembali Berdasarkan Jenis Kelamin <?=$data['y_last']?> Tahun Terakhir Jenjang S1',
            filename: 'Rekap Daftar Kembali Berdasarkan Jenis Kelamin <?=$data['y_last']?> Tahun Terakhir Jenjang S1',
            footer: true,
            exportOptions: {
