...
$('#DA5tahun').DataTable({
    ...
    buttons: [
        {
            extend: 'excel',
            title: 'Rekap Daftar Kembali Berdasarkan Daerah Asal <?=$data['y_last']?> Tahun Terakhir',
            filename: 'Rekap Daftar Kembali Berdasarkan Daerah Asal <?=$data['y_last']?> Tahun Terakhir',
            footer: true,
            exportOptions: {
