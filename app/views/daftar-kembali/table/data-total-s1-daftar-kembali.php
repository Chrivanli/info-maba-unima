...
$('#MabaS1Total').DataTable({
    ...
    buttons: [
        {
            extend: 'excel',
            title: 'Rekap Daftar Kembali Berdasarkan Total <?=$data['y_last']?> Tahun Terakhir Jenjang S1',
            filename: 'Rekap Daftar Kembali Berdasarkan Total <?=$data['y_last']?> Tahun Terakhir Jenjang S1',
            footer: true,
            exportOptions: 
            {
