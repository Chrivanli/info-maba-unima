...
<main>
    <div class="col py-3 d-none d-sm-block sub-nav-bg">
            <ol class="breadcrumb mb-1 px-3 fs-6 fw-semibold">
                ...
                <li class="breadcrumb-item"><a href="<?= BASEURL; ?>/daftar_kembali/maba_daftar_kembali" class="link">Jalur Pendaftaran - Tahun <?= $data['y_post']; ?></a></li>
            </ol>
    </div>
    ...
    <div class="container-fluid">
        <div class="col mt-3">
            ...
            <div class="card mb-3 animate__animated animate__fadeIn">
                ...
                <div class="card-body">
                    <?php require_once 'table/data-maba-s1-daftar-kembali.php' ?>
                </div>
            </div>
            <div class="card mb-2 animate__animated animate__fadeIn">
                ...
                <div class="card-body">
                    <?php require_once 'table/data-maba-d3-daftar-kembali.php' ?>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form id="myForm" method="POST" action="<?= BASEURL; ?>/daftar_kembali/maba_daftar_kembali">
