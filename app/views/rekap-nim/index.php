<main>
    <div class="col mb-3 py-3 d-none d-sm-block sub-nav-bg">
        <ol class="breadcrumb mb-1 px-3 fs-6 fw-semibold">
            ...
            <li class="breadcrumb-item"><a href="<?= BASEURL; ?>/rekap_nim" class="link">Rekap Nomor Induk Mahasiswa</a></li>
        </ol>
    </div>
    <div class="container-fluid px-4 mt-3">
        <div class="card mb-1 shadow-sm animate__animated animate__fadeIn">
            <div class="card-header text-light text-center">
                <h5 class="card-title ps-3 m-0">MAHASISWA BARU REKAP NIM</h5>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col mb-2">
                ...
                <div class="col-12 mb-2 text-center">
                    <div class="card text-light nim-bg shadow-sm animate__animated animate__bounceInRight">
            ...
            <div class="col-12">
                <div class="card card-menu mb-3 col-12 shadow-sm animate__animated animate__slideInLeft">
                    <div class="card-body p-3 ">
                        ...
                        <p class="card-text">Berisi data rekap NIM berdasarkan jalur pendaftaran. Dibagi menjadi data 5 tahun terakhir dan data setiap tahun</p>
                        <div class="text-end">
                            <a href="<?= BASEURL; ?>/rekap_nim/maba_rekap_nim_5y" class="btn btn-primary  shadow-sm" style="width: 200px;">5 Tahun Terakhir</a>
                            <a href="<?= BASEURL; ?>/rekap_nim/maba_rekap_nim" class="btn btn-primary  shadow-sm" style="width: 200px;">Tahun <?=$data['lastYear']?></a>
                        </div>
                    </div>
                </div>
                <div class="card card-menu mb-3 col-12 shadow-sm animate__animated animate__slideInRight">
                    <div class="card-body p-3 ">
                        ...
                        <p class="card-text">Berisi data rekap NIM berdasarkan jenis kelamin dari pendaftar. Dibagi menjadi data 5 tahun terakhir dan data setiap tahun</p>
                        <div class="text-end">
                            <a href="<?= BASEURL; ?>/rekap_nim/jenis_kelamin_5y" class="btn btn-primary  shadow-sm" style="width: 200px;">5 Tahun Terakhir</a>
                            <a href="<?= BASEURL; ?>/rekap_nim/jenis_kelamin" class="btn btn-primary  shadow-sm" style="width: 200px;">Tahun <?=$data['lastYear']?></a>
                        </div>
                    </div>
                </div>
                <div class="card card-menu mb-3 col-12 shadow-sm animate__animated animate__slideInLeft">
                    <div class="card-body p-3 ">
                        ...
                        <p class="card-text">Berisi data rekap NIM berdasarkan daerah asal dari pendaftar. Dibagi menjadi data 5 tahun terakhir dan data setiap tahun</p>
                        <div class="text-end">
                            <a href="<?= BASEURL; ?>/rekap_nim/daerah_asal_5y" class="btn btn-primary  shadow-sm" style="width: 200px;">5 Tahun Terakhir</a>
                            <a href="<?= BASEURL; ?>/rekap_nim/daerah_asal" class="btn btn-primary  shadow-sm" style="width: 200px;">Tahun <?=$data['lastYear']?></a>
                        </div>
                    </div>
                </div>
                <div class="card card-menu mb-3 col-12 shadow-sm animate__animated animate__slideInRight">
                    <div class="card-body p-3 ">
                        ...
                        <p class="card-text">Berisi total rekap NIM</p>
                        <div class="text-end">
                            <a href="<?= BASEURL; ?>/rekap_nim/total" class="btn btn-primary  shadow-sm" style="width: 200px;">Total</a>
                        </div>
                    </div>
                </div>
            </div>
