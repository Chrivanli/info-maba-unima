...
$('#MabaD3').DataTable({
    ...
    buttons: [
        {
            extend: 'excel',
            title: 'Rekap NIM Berdasarkan Jalur Pendaftaran <?=$data['y_last']?> Tahun Terakhir Jenjang D3',
            filename: 'Rekap NIM Berdasarkan Jalur Pendaftaran <?=$data['y_last']?> Tahun Terakhir Jenjang D3',
            footer: true,
            exportOptions: {
