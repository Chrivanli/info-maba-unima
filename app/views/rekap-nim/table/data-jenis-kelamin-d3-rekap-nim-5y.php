...
$('#MabaJKD3').DataTable({
    ...
    buttons: [
        {
            extend: 'excel',
            title: 'Rekap NIM Berdasarkan Jenis Kelamin <?=$data['y_last']?> Tahun Terakhir Jenjang D3',
            filename: 'Rekap NIM Berdasarkan Jenis Kelamin <?=$data['y_last']?> Tahun Terakhir Jenjang D3',
            footer: true,
            exportOptions: {
