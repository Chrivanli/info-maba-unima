...
<script>
    new DataTable('#MabaS1Reg', {
        ...
        buttons: [
            {
                extend: 'excel',
                title: 'Rekap NIM Berdasarkan Jalur Pendaftaran Tahun <?=$data['y_post']?> Jenjang S1',
                filename: 'Rekap NIM Berdasarkan Jalur Pendaftaran Tahun <?=$data['y_post']?> Jenjang S1',
                footer: true
            },
            ],
        columnDefs: [
