...
<script>
    new DataTable('#MabaD3Reg', {
        ...
        buttons: [
            {
                extend: 'excel',
                title: 'Rekap NIM Berdasarkan Jalur Pendaftaran Tahun <?=$data['y_post']?> Jenjang D3',
                filename: 'Rekap NIM Berdasarkan Jalur Pendaftaran Tahun <?=$data['y_post']?> Jenjang D3',
                footer: true
            },
            ],
        columnDefs: [
