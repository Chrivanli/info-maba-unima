<main>
    <div class="col py-3 d-none d-sm-block sub-nav-bg">
            <ol class="breadcrumb mb-1 px-3 fs-6 fw-semibold">
                ...
                <li class="breadcrumb-item"><a href="<?=BASEURL;?>/rekap_nim/daerah_asal_5y" class="link">Daerah Asal - <?=$data['y_last']?> Tahun Terakhir</a></li>
            </ol>
    </div>
        ...
        <div class="col mt-3">
            ...
            <div class="card-header text-light">
                    <div class="row">
                        ...
                        <div class="col-2">
                            <form id="myForm" method="POST" action="<?= BASEURL; ?>/rekap_nim/daerah_asal_5y">
                    ...
                    <div class="card animate__animated animate__fadeInLeft">
                        <div class="card-body pt-0" style="height: 265px;">
                            <a class="pe-3 mt-1 btn z-0 position-absolute top-0 end-0" id="downloadLineChart" 
                                download="PolarAreaChart Perbandingan Maba Diluar Sulut Rekap NIM 5 Tahun Terakhir.png" href="">
            ...
            <div class="card mb-3 animate__animated animate__fadeIn">
                ...
                <div class="card-body">
                    <?php require 'table/data-daerah-asal-rekap-nim-5y.php' ?>
                </div>
            </div>
        </div>
    </div>
