...
<main>
    <div class="col py-3 d-none d-sm-block sub-nav-bg">
            <ol class="breadcrumb mb-1 px-3 fs-6 fw-semibold">
                ...
                <li class="breadcrumb-item"><a href="<?= BASEURL; ?>/lulus_seleksi/total" class="link">Total - <?=$data['y_last']?> Tahun Terakhir</a></li>
            </ol>
    </div>
    <div class="container-fluid px-4">
        <div class="col mt-3">
            <div class="card mb-1 animate__animated animate__fadeIn">
                <div class="card-header text-light ">
                    <div class="row">
                        ...
                        <div class="col">
                            <h5 class="card-title text-center mb-0">TOTAL LULUS SELEKSI - <?=$data['y_last']?> TAHUN TERAKHIR</h5>
                        </div>
                    ...
                    <div class="card animate__animated animate__fadeInLeft">
                        <div class="card-body pt-0" style="height: 265px;">
                            <a class="pe-3 mt-1 btn z-0 position-absolute top-0 end-0" id="downloadLineChart" 
                                download="LineChart Total Maba Lulus Seleksi 7 Tahun Terakhir.png" href="">
            ...
            <div class="card mb-3 animate__animated animate__fadeIn">
                ...
                <div class="card-body">
                    <?php require 'table/data-total-s1-lulus-seleksi.php' ?>
                </div>
            </div>
            <div class="card mb-3 animate__animated animate__fadeIn">
                <div class="card-header text-light">
                ...
                <div class="card-body">
                    <?php require 'table/data-total-d3-lulus-seleksi.php' ?>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form id="myForm" method="POST" action="<?= BASEURL; ?>/lulus_seleksi/total">
