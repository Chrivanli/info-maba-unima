...
<script>
    ...
    $('#MabaJKS1').DataTable({
        ...
        buttons: [
            {
                extend: 'excel',
                title: 'Rekap Lulus Seleksi Berdasarkan Jenis Kelamin Tahun <?=$data['y_post']?> Jenjang S1',
                filename: 'Rekap Lulus Seleksi Berdasarkan Jenis Kelamin Tahun <?=$data['y_post']?> Jenjang S1',
                footer: true
            },
            ],
        columnDefs: [
