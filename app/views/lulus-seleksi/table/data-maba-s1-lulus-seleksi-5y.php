...
$('#MabaS1').DataTable({
    ...
    buttons: [
        {
            extend: 'excel',
            title: 'Rekap Lulus Seleksi Berdasarkan Jalur Pendaftaran <?=$data['y_last']?> Tahun Terakhir Jenjang S1',
            filename: 'Rekap Lulus Seleksi Berdasarkan Jalur Pendaftaran <?=$data['y_last']?> Tahun Terakhir Jenjang S1',
            footer: true,
            exportOptions: {
