...
<script>
    new DataTable('#MabaS1Reg', {
        ...
        buttons: [
            {
                extend: 'excel',
                title: 'Rekap Lulus Seleksi Berdasarkan Jalur Pendaftaran Tahun <?=$data['y_post']?> Jenjang S1',
                filename: 'Rekap Lulus Seleksi Berdasarkan Jalur Pendaftaran Tahun <?=$data['y_post']?> Jenjang S1',
                footer: true
            },
            ],
        columnDefs: [
