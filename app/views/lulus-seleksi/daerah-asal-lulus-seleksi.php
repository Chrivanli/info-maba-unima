<main>
    <div class="col py-3 d-none d-sm-block sub-nav-bg">
            <ol class="breadcrumb mb-1 px-3 fs-6 fw-semibold">
                ...
                <li class="breadcrumb-item"><a href="<?=BASEURL;?>/lulus_seleksi/daerah_asal" class="link">Daerah Asal - Tahun <?= $data['y_post'] ?></a></li>
            </ol>
    </div>
    <div class="container-fluid px-4">
        <div class="col mt-3">
            <div class="card mb-1 animate__animated animate__fadeIn">
                <div class="card-header text-light ">
                    <div class="row">
                        ...
                        <div class="col-2">
                            <form id="myForm" method="POST" action="<?= BASEURL; ?>/lulus_seleksi/daerah_asal">
                    ...
                    <div class="card animate__animated animate__fadeInLeft">
                        <div class="card-body pt-0" style="height: 265px;">
                            <a class="pe-3 mt-1 btn z-0 position-absolute top-0 end-0" id="downloadpolarAreaChart" 
                                download="PolarAreaChart Perbandingan Maba Diluar Sulut Lulus Seleksi Tahun <?= $data['y_post'] ?>.png" href="">
                    ...
                    <div class="card animate__animated animate__fadeInRight">
                        <div class="card-body pt-0" style="height: 265px;">
                            <a class="pe-3 mt-1 btn z-0 position-absolute top-0 end-0" id="downloadbarChart" 
                                download="BarChart Daerah Asal Maba Berdasarkan Jalur Pendaftaran Tahun <?= $data['y_post'] ?>.png" href="">
                                <i data-feather="download" style="width: 80%;"></i>
                            </a> 
            ...
            <div class="card mb-3 animate__animated animate__fadeIn">
                ...
                <div class="card-body">
                    <?php require 'table/data-daerah-asal-lulus-seleksi.php' ?>
                </div>
            </div>
        </div>
    </div>
